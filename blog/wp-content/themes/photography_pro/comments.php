...
<?php if ( have_comments() ) : ?>
	...
	<ol class="commentlist">
		<?php if ( $photography->colorScheme() == 'light' ) {
				wp_list_comments( 'type=comment&callback=photography_custom_comment_light' );
			} else {
				wp_list_comments( 'type=comment&callback=photography_custom_comment' );
			}
		?>
	</ol>
