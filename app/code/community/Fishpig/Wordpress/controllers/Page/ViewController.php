	...
	protected function _init()
	{
		if ($page = $this->_getPage()) {
			...
			while ($buffer) {
				...
				# Get custom page title from database - in the Wordpress theme functions.php file the custom_title field is setup
				# http://digwp.com/2010/04/custom-page-titles/
				$this->_title($buffer->getCustomField('_custom_title'));
