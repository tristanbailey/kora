 ...
 * File path:   app/code/local/Aitoc/Aitpreorder/Model/Checkout/Cart/Observer.php
 * Copyright:   (c) 2012 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitpreorder')){ ZawONoapWZSDroZB('cea24ce6e02653deb4d43a353837e9e0'); ?><?php
class Aitoc_Aitpreorder_Model_Checkout_Cart_Observer extends Mage_Core_Model_Abstract
{
