 ...
 * File path:   app/code/local/Aitoc/Aitpreorder/Model/Order/Observer.php
 * Copyright:   (c) 2012 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitpreorder')){ ZawONoapWZSDroZB('4d7d9b8a6cfbbd146c6cb9f85e487da0'); ?><?php
class Aitoc_Aitpreorder_Model_Order_Observer extends Mage_Core_Model_Abstract
{
