...
/**
 * Order readjust methods source
 *
 * @category   Innoexts
 * @package    Innoexts_CurrencyGeoFilter
 * @author     Innoexts Team <developers@innoexts.com>
 */
class Innoexts_CurrencyGeoFilter_Model_Source_Orderreadjustmethod
{
    /**
     * Retrieve helper
     * 
    ...
    public function toOptionArray()
    {
        ...
        return array(
            array('value' => 'shipping', 'label' => $helper->__('Shipping Address')), 
            array('value' => 'billing', 'label' => $helper->__('Billing Address')), 
        );
    }
}